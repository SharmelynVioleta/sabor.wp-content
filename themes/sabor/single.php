...
$blog_image_or_video = get_field('blog_image_or_video', $post->ID);
      ...
      <div class="container">
         <div class="blog-heading">
            ...
            <a href="<?php echo get_author_posts_url($author_id); ?>" class="chef-name">
               ...
               <?php if(!empty($author_obj->display_name)) :?> 
         ...
         <div class="blog-image">
               <?php
               if($blog_image_or_video == "video"){
                  echo $singel_video;
               } elseif ($blog_image_or_video == "image") {
         ...
         <?php
            if ( is_active_sidebar( 'blog_before_content_advertisement' ) ) :
               dynamic_sidebar( 'blog_before_content_advertisement' );
            endif;
         ?>
         <div class="blog-content">
            ...
            <div class="testimonial">
               ...
               <div class="content">
                  <h5><a href="<?php echo get_author_posts_url($author_id); ?>"><?php  echo $author_obj->display_name;?></a></h5>
                  <?php if(!empty($biography)) : ?>
                  <p><?php echo $biography; ?></p>
                  <?php endif; ?>
                  <?php if(!empty($author_social_icons_list)): ?>
                     <ul>
                        <?php
         ...
         <?php
            if ( is_active_sidebar( 'blog_after_content_advertisement' ) ) :
               dynamic_sidebar( 'blog_after_content_advertisement' );
            endif;
         ?>
      </div>
   </div>
