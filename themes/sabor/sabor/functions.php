 ...
 */
function sabor_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'sabor' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'sabor' ),
...
add_action( 'widgets_init', 'sabor_widgets_init' );
...
function sabor_modify_rating_strings( $stringsArray ) {
	...
	$stringsArray['rateSubtitle'] = 'Califica nuestra contenido';
